...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': [  # настройки лимитов
    ...
    'DEFAULT_THROTTLE_RATES': {
        'user': '10000/day',
        'anon': '1000/day',
        'low_request': '1/minutes',
    },
    'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.PageNumberPagination',  # настройки пагинации
    'PAGE_SIZE': 5, 
}
